# Awesome Long-Tailed Learning (TPAMI 2023)
  ...
  | [Long-Tailed Anomaly Detection with Learnable Class Names](https://openaccess.thecvf.com/content/CVPR2024/papers/Ho_Long-Tailed_Anomaly_Detection_with_Learnable_Class_Names_CVPR_2024_paper.pdf) | CVPR | 2024 | `TL`,`Aug` |       
  | [Delving into the Trajectory Long-tail Distribution for Muti-object Tracking](https://openaccess.thecvf.com/content/CVPR2024/papers/Chen_Delving_into_the_Trajectory_Long-tail_Distribution_for_Muti-object_Tracking_CVPR_2024_paper.pdf) | CVPR | 2024 | `Aug`,`CD` |  [Official](https://zenodo.org/records/10854201)        |  
